// https://github.com/leek-wars/leek-wars/tree/master/public/image/weapon

divs = document.getElementsByClassName("react-directory-filename-cell");

chip_name_to_image = {};

// https://github.com/leek-wars/leek-wars/blob/master/public/image/weapon/whip.png
// https://raw.githubusercontent.com/leek-wars/leek-wars/refs/heads/master/public/image/weapon/whip.png
curlScript = "";
...
for (let i = 1; i < divs.length; i += 2) {
  ...
  curlUrl =
    "https://raw.githubusercontent.com/leek-wars/leek-wars/refs/heads/master/public/image/weapon/";
  curlScript += 'curl -O "' + curlUrl + imgFileName + '"\n';

  newImgUrl = "/assets/images/weapons/" + imgFileName;
